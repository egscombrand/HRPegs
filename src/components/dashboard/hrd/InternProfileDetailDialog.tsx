...
const SectionTitle = ({ children }: { children: React.ReactNode }) => (
  <h3 className="text-lg font-semibold tracking-tight border-b pb-2 mb-4">
    {children}
  </h3>
);
...
export function InternProfileDetailDialog({
  ...
  onOpenChange,
  onAdminDataChange,
}: InternProfileDetailDialogProps) {
  ...
  const isLoadingDetails =
    isLoadingApplication || isLoadingUser || isLoadingBrands || isLoadingJob;
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-3xl h-[90vh] flex flex-col p-0">
          <DialogHeader className="p-6 pb-4 border-b flex-row items-center justify-between">
            <div>
              <DialogTitle>
                Detail Profil Magang: {profile.fullName}
              </DialogTitle>
            ...
            >
              <Edit className="mr-2 h-4 w-4" /> Edit Data Administrasi
            </Button>
          </DialogHeader>
                  ...
                  {isLoadingApplication ? (
                    ...
                    <dl className="space-y-1 text-sm">
                      <InfoRow
                        ...
                        value={
                          compensationToDisplay
                            ? `Rp ${compensationToDisplay.toLocaleString("id-ID")}`
                            : "Belum diatur"
                        }
                      />
                      <InfoRow
                        ...
                        value={
                          startDateToDisplay
                            ? format(startDateToDisplay, "dd MMMM yyyy", {
                                locale: id,
                              })
                            : "Belum diatur"
                        }
                      ...
                      <InfoRow
                        ...
                        value={
                          endDateToDisplay
                            ? format(endDateToDisplay, "dd MMMM yyyy", {
                                locale: id,
                              })
                            : "Belum diatur"
                        }
