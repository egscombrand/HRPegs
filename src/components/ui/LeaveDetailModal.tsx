...
export function LeaveDetailModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[9999] bg-black/70 flex items-center justify-center p-4">
      {/* Box Modal */}
      <div className="w-full max-w-4xl max-h-[85vh] bg-slate-950 border border-slate-800 rounded-2xl overflow-hidden flex flex-col text-slate-100 shadow-2xl">
        {/* Header */}
        <div className="sticky top-0 bg-slate-950 border-b border-slate-800 p-5 flex items-start justify-between gap-4 z-20">
        ...
        <div className="overflow-y-auto max-h-[calc(85vh-150px)] p-5 space-y-6 flex-1">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-4 bg-slate-900/50 rounded-xl border border-slate-800/80 space-y-1">
          ...
          <div className="space-y-4">
            <div className="space-y-1">
              ...
              <p className="text-sm font-medium text-slate-300 bg-slate-950 p-3 rounded-lg border border-slate-800">
                {request.reason || "-"}
              </p>
            </div>
            <div className="space-y-1">
          ...
          <div className="p-4 bg-indigo-950/10 rounded-2xl border border-indigo-900/20 space-y-4">
            ...
            <div className="space-y-1 pt-2 border-t border-indigo-900/10">
              <p className="text-[10px] font-black text-slate-500 uppercase tracking-wider">
                Catatan Serah Terima Tugas
              </p>
              <p className="text-sm font-medium text-slate-300 bg-slate-950/50 p-3 rounded-lg border border-slate-800/80">
          ...
          <div className="p-4 bg-slate-900/50 rounded-2xl border border-slate-800/80 space-y-4">
            <p className="text-xs font-black text-slate-500 uppercase tracking-widest">
              Timeline Alur Persetujuan
            </p>
            <div className="relative pl-6 space-y-5 before:absolute before:left-[11px] before:top-2 before:bottom-2 before:w-[2px] before:bg-slate-800">
        ...
        <div className="sticky bottom-0 bg-slate-950 border-t border-slate-800 p-4 flex justify-end z-20">
          <Button
            onClick={onClose}
            className="bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-xl px-5 border border-slate-700"
          >
            Tutup
          </Button>
        </div>
