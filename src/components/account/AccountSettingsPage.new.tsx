...
export function AccountSettingsPage() {
  ...
  const roleSummary = useMemo(() => {
    switch (userProfile?.role) {
      case "super-admin":
        return "Akses penuh ke semua modul internal.";
      case "hrd":
        return "Akses pengelolaan HRD dan persetujuan karyawan.";
      case "manager":
        return "Akses manajerial untuk tim dan persetujuan tugas.";
      case "karyawan":
        return "Akses pengguna internal untuk aktivitas operasional.";
      case "kandidat":
        return "Akses kandidat untuk portal rekrutmen.";
      default:
        return "Role ini tidak dapat diubah sendiri. Hubungi HRD/Admin untuk perubahan.";
    }
  }, [userProfile?.role]);
  ...
  const handleResendVerification = async () => {
    ...
    try {
      ...
      setEmailActionMessage(
        "Email verifikasi telah dikirim ulang. Silakan cek inbox.",
      );
    } catch {
      setEmailActionError(
