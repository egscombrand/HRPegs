...
export function PostInterviewEvaluationSection({
  ...
  return (
    <Card className="shadow-2xl border border-slate-200 dark:border-none rounded-[3rem] bg-white dark:bg-[#020617]/40 dark:backdrop-blur-xl overflow-hidden border-t-8 border-teal-500/20 dark:ring-1 dark:ring-white/5">
      <CardHeader className="bg-teal-50 dark:bg-teal-500/[0.03] pb-10 border-b border-slate-200 dark:border-slate-800/50">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-2">
            <Badge className="bg-teal-100 dark:bg-teal-500/20 text-teal-700 dark:text-teal-400 border border-teal-300 dark:border-teal-500/30 px-4 py-1.5 rounded-full font-black text-[10px] uppercase tracking-widest">
              Interview Stage
            </Badge>
          </div>
        </div>
      ...
      <CardContent className="p-6 md:p-12 space-y-20">
        ...
        {canSeeDashboard && (
          <div className="space-y-12 animate-in fade-in slide-in-from-top-6 duration-1000">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-8 p-10 rounded-[2.5rem] bg-white dark:bg-slate-950/40 border border-slate-200 dark:border-slate-800 shadow-2xl ring-1 ring-slate-200/50 dark:ring-white/5">
              <div className="flex items-center gap-6">
                ...
                <div>
                  <h3 className="text-2xl font-black uppercase tracking-tighter text-slate-900 dark:text-slate-100 italic">
                    Progress Penilaian Tim (Pasca)
                  </h3>
                  <div className="space-y-1">
                    <p className="text-sm font-bold text-slate-600 dark:text-slate-500 uppercase tracking-widest">
        ...
        {canReview && (
          <div className="space-y-12 p-12 rounded-[3.5rem] bg-white dark:bg-slate-950/40 border border-slate-200 dark:border-slate-800 shadow-2xl ring-1 ring-slate-200/50 dark:ring-white/5">
            <div className="flex items-center gap-5">
              <div className="h-12 w-12 rounded-[1.2rem] bg-teal-500/10 text-teal-600 dark:text-teal-400 flex items-center justify-center border border-teal-300 dark:border-teal-500/20 shadow-inner">
                <MessageSquare className="h-6 w-6" />
              </div>
              <div>
                <h3 className="text-2xl font-black tracking-tight text-slate-900 dark:text-slate-100 uppercase italic">
                  Form Penilaian Saya (Pasca)
                </h3>
                <p className="text-[10px] font-black text-slate-600 dark:text-slate-500 uppercase tracking-widest mt-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              <div className="lg:col-span-2 space-y-6">
                <label className="text-xs font-black text-slate-700 dark:text-slate-500 uppercase tracking-[0.25em] pl-4 border-l-4 border-teal-500">
                  REKOMENDASI AKHIR
                </label>
                    ...
                    <button
                      ...
                      className={cn(
                        ...
                        recommendation === s
                          ...
                          : "border-slate-300 dark:border-slate-800 bg-slate-100 dark:bg-slate-950/40 hover:border-teal-400 dark:hover:border-teal-500/30 text-slate-700 dark:text-slate-400",
                      )}
                    >
              ...
              <div className="md:col-span-2 space-y-5">
                ...
                <div className="relative">
                  <Textarea
                    ...
                    className="min-h-[150px] rounded-[2.5rem] resize-none p-8 text-lg font-medium border-2 border-slate-300 dark:border-slate-800 bg-white dark:bg-slate-950/60 text-slate-900 dark:text-slate-200 focus:border-teal-400 dark:focus:border-teal-500/50 focus:ring-4 focus:ring-teal-500/5 transition-all shadow-inner"
                    value={notes}
                    onChange={(e) => setNotes(e.target.value)}
                  />
                  <div className="absolute bottom-6 right-8 text-[10px] font-black text-slate-600 dark:text-slate-600 uppercase">
                    {notes.length} / 20 MIN
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-5">
                <label className="text-xs font-black text-slate-700 dark:text-slate-500 uppercase tracking-[0.25em] pl-4 border-l-4 border-emerald-500">
                  Kekuatan Utama
                </label>
                <Textarea
                  placeholder="Apa keunggulan yang terlihat saat interview?"
                  className="min-h-[110px] rounded-[2rem] text-sm border-2 border-emerald-300 dark:border-slate-800 bg-emerald-50 dark:bg-emerald-500/[0.02] text-slate-900 dark:text-slate-300 focus:border-emerald-400 dark:focus:border-emerald-500/50 transition-all shadow-sm"
                  value={strengths}
              ...
              <div className="space-y-5">
                <label className="text-xs font-black text-slate-700 dark:text-slate-500 uppercase tracking-[0.25em] pl-4 border-l-4 border-amber-500">
                  Hal yang Perlu Diperhatikan
                </label>
                <Textarea
                  placeholder="Kekhawatiran atau area yang butuh klarifikasi..."
                  className="min-h-[110px] rounded-[2rem] text-sm border-2 border-amber-300 dark:border-slate-800 bg-amber-50 dark:bg-amber-500/[0.02] text-slate-900 dark:text-slate-300 focus:border-amber-400 dark:focus:border-amber-500/50 transition-all shadow-sm"
                  value={concerns}
            ...
            <div className="flex items-center justify-between mt-8 p-4 rounded-3xl bg-teal-50 dark:bg-teal-900/10 border border-teal-200 dark:border-teal-500/10">
        ...
        <div className="space-y-12">
          <div className="flex items-center justify-between px-6">
            <div className="flex items-center gap-5">
              <div className="h-12 w-12 rounded-[1.2rem] bg-teal-100 dark:bg-teal-500/10 text-teal-700 dark:text-teal-400 flex items-center justify-center border border-teal-300 dark:border-teal-500/20">
            ...
            <Button
              ...
              className="rounded-[1.5rem] font-black uppercase border-2 border-slate-300 text-slate-700 hover:bg-teal-600 hover:text-white hover:border-teal-600 transition-all text-[10px] tracking-widest px-8 dark:border-slate-700 dark:text-slate-400 dark:hover:bg-teal-600 dark:hover:border-teal-600"
            >
              {showAllReviews ? (
            ...
            <div className="space-y-10">
              {myReview && (
                <div className="space-y-8 px-6">
                  <div className="flex items-center gap-5">
                    <div className="h-12 w-12 rounded-[1.2rem] bg-slate-100 dark:bg-slate-900/80 text-teal-600 dark:text-teal-400 flex items-center justify-center border border-teal-300 dark:border-teal-500/20">
                  ...
                  <div className="grid grid-cols-1 gap-5">
                    <div
                      ...
                      className="p-12 rounded-[4rem] bg-slate-50 dark:bg-slate-950/20 border border-slate-200 dark:border-slate-800 shadow-2xl space-y-10 relative overflow-hidden ring-1 ring-slate-200/50 dark:ring-white/5"
                    >
                      <div className="flex flex-col sm:flex-row items-start justify-between gap-8 relative z-10">
                        <div className="flex items-center gap-6">
                          <div className="h-20 w-20 rounded-[1.8rem] bg-slate-200 dark:bg-slate-900 border border-slate-300 dark:border-slate-800 shadow-inner flex items-center justify-center font-black text-3xl text-slate-600 dark:text-slate-600 group-hover:bg-teal-600 group-hover:text-white transition-all duration-700">
                            {myReview.reviewerName.charAt(0)}
                          </div>
                          <div>
                            <p className="font-black text-3xl uppercase tracking-tighter leading-tight text-slate-900 dark:text-slate-100 italic">
                              {myReview.reviewerName}
                            </p>
                            <div className="flex items-center gap-4 text-[10px] font-black text-slate-600 dark:text-slate-500 uppercase tracking-widest mt-2">
                              <Badge
                                variant="outline"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-8 rounded-[2.5rem] bg-slate-100 dark:bg-slate-950/40 border border-slate-200 dark:border-slate-800 shadow-inner">
                        <div className="space-y-1">
                          <p className="text-[9px] font-black text-slate-700 dark:text-slate-600 uppercase tracking-widest">
                            Komunikasi
                          </p>
                          <div className="flex text-teal-500 dark:text-teal-400 pb-1">
                            {[1, 2, 3, 4, 5].map((i) => (
                              <Star
                                key={i}
                                className={cn(
                          ...
                          <div className="flex text-teal-500 dark:text-teal-400 pb-1">
                            {[1, 2, 3, 4, 5].map((i) => (
                              <Star
                                ...
                                className={cn(
                                  "h-4 w-4 fill-current",
                                  i > myReview.fitScore && "text-slate-300 dark:text-slate-800",
                                )}
                              />
                            ))}
                          </div>
                      ...
                      <div className="text-2xl leading-[1.6] text-slate-700 dark:text-slate-300 font-medium bg-slate-100 dark:bg-slate-900/40 p-12 rounded-[3.5rem] relative border-l-8 border-teal-300 dark:border-teal-500/30 group-hover:bg-slate-200 dark:group-hover:bg-slate-900/60 transition-all shadow-inner italic">
                        &ldquo; {myReview.notes} &rdquo;
                      </div>

                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                        <div className="p-10 rounded-[2.5rem] border border-emerald-300 dark:border-emerald-500/10 bg-emerald-50 dark:bg-emerald-500/[0.02] transition-all">
                          <p className="text-[10px] font-black uppercase text-emerald-700 dark:text-emerald-500/60 mb-4 tracking-[0.3em] flex items-center gap-2">
                            <CheckCircle className="h-4 w-4" /> Kekuatan Utama
                          </p>
                          <p className="text-lg font-bold text-slate-700 dark:text-slate-400 leading-relaxed italic">
                            {myReview.strengths || "-"}
                          </p>
                        </div>
                        <div className="p-10 rounded-[2.5rem] border border-rose-300 dark:border-rose-500/10 bg-rose-50 dark:bg-rose-500/[0.02] transition-all">
                          <p className="text-[10px] font-black uppercase text-rose-700 dark:text-rose-500/60 mb-4 tracking-[0.3em] flex items-center gap-2">
                ...
                {sortedOtherReviews.length > 0 ? (
                  sortedOtherReviews.map((review) => (
                    <div
                      ...
                      className="p-12 rounded-[4rem] bg-white dark:bg-slate-950/20 border border-slate-200 dark:border-slate-800 shadow-2xl space-y-10 group transition-all duration-700 hover:bg-slate-100 dark:hover:bg-slate-950/40 hover:border-teal-300 dark:hover:border-teal-500/20 relative overflow-hidden ring-1 ring-slate-200/50 dark:ring-white/5"
                    >
                      <div className="flex flex-col sm:flex-row items-start justify-between gap-8 relative z-10">
                        <div className="flex items-center gap-6">
                          <div className="h-20 w-20 rounded-[1.8rem] bg-slate-200 dark:bg-slate-900 border border-slate-300 dark:border-slate-800 shadow-inner flex items-center justify-center font-black text-3xl text-slate-700 dark:text-slate-600 group-hover:bg-teal-600 group-hover:text-white transition-all duration-700">
                            {review.reviewerName.charAt(0)}
                          </div>
                          <div>
                            <p className="font-black text-3xl uppercase tracking-tighter leading-tight text-slate-900 dark:text-slate-100 group-hover:translate-x-1 transition-transform duration-500 italic">
                              {review.reviewerName}
                            </p>
                            <div className="flex items-center gap-4 text-[10px] font-black text-slate-600 dark:text-slate-500 uppercase tracking-widest mt-2">
                              <Badge
                          ...
                          <div className="flex text-teal-500 dark:text-teal-400 pb-1">
                            {[1, 2, 3, 4, 5].map((i) => (
                              <Star
                                ...
                                className={cn(
                                  "h-4 w-4 fill-current",
                                  i > review.attitudeScore && "text-slate-300 dark:text-slate-800",
                                )}
                              />
                            ))}
                          </div>
                          ...
                          <div className="flex text-teal-500 dark:text-teal-400 pb-1">
                            {[1, 2, 3, 4, 5].map((i) => (
                              <Star
                                ...
                                className={cn(
                                  "h-4 w-4 fill-current",
                                  i > review.fitScore && "text-slate-300 dark:text-slate-800",
                                )}
                              />
                            ))}
                          </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                        <div className="p-10 rounded-[2.5rem] border border-emerald-300 dark:border-emerald-500/10 bg-emerald-50 dark:bg-emerald-500/[0.02] group-hover:bg-emerald-100 dark:group-hover:bg-emerald-500/[0.04] transition-all">
                          <p className="text-[10px] font-black uppercase text-emerald-700 dark:text-emerald-500/60 mb-4 tracking-[0.3em] flex items-center gap-2">
                            <CheckCircle className="h-4 w-4" /> Kekuatan Utama
                          </p>
                          <p className="text-lg font-bold text-slate-700 dark:text-slate-400 leading-relaxed italic">
                        ...
                        <div className="p-10 rounded-[2.5rem] border border-rose-300 dark:border-rose-500/10 bg-rose-50 dark:bg-rose-500/[0.02] group-hover:bg-rose-100 dark:group-hover:bg-rose-500/[0.04] transition-all">
                          <p className="text-[10px] font-black uppercase text-rose-700 dark:text-rose-500/60 mb-4 tracking-[0.3em] flex items-center gap-2">
                            <AlertCircle className="h-4 w-4" /> Perlu Perhatian
                          </p>
                          <p className="text-lg font-bold text-slate-700 dark:text-slate-400 leading-relaxed italic">
                  ...
                  <div className="p-16 text-center rounded-[2.5rem] bg-slate-100 dark:bg-slate-900/20 border-2 border-dashed border-slate-300 dark:border-slate-800">
                    <AlertCircle className="h-12 w-12 mx-auto text-slate-500 dark:text-slate-700 mb-4" />
                    <p className="text-slate-700 dark:text-slate-500 text-sm font-bold italic uppercase tracking-widest">
