            ...
            <div className="flex flex-col sm:flex-row justify-between sm:items-start gap-4">
              <div>
                ...
                <CardDescription>
                  ...
                  seluruh detail penawaran dengan saksama. Keputusan yang Anda
                  berikan bersifat final dan tidak dapat diubah melalui sistem.
                </CardDescription>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 pt-4 text-sm">
              ...
              {application.workDays && (
                <div>
                  ...
                  <p className="font-semibold">{application.workDays}</p>
                </div>
              )}
              <div>
